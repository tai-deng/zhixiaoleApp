            ...
            if ($.isFunction(self.options.down.callback)) {
                self.pullDownTips = (function() {
                    ...
                    if (!element) {
                        ...
                        element.innerHTML = '<div class="mui-pull-top-wrapper mui-text-center margintop-20px"><span class="mui-pull-loading mui-icon mui-icon-pulldown"></span></div>';
            ...
            if ($.isFunction(self.options.up.callback)) {
                self.pullUpTips = (function() {
                    ...
                    if (!element) {
                        ...
                        element.innerHTML = '<div class="mui-pull-bottom-wrapper mui-text-center margintop-20px"><span class="mui-pull-loading">' + self.options.up.contentdown + '</span></div>';
